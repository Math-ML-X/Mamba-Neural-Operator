...
from dataset.dataset_diffusion_reaction_2d_pdebench_d3 import DiffusionReaction2DDataset
import argparse
from datetime import datetime


def main(config_path='config/dr2d_pdebench/config_gt_dr2d_pdebench.yml'):
    ...
    train_dataset = DiffusionReaction2DDataset(dataset_params=config['dataset'], split='train')
    valid_dataset = DiffusionReaction2DDataset(dataset_params=config['dataset'], split='test')
    ...
    model_name = get_model_name(model='dr2d_pdebench',
    ...
    result = run_train_pdebench(model=model,
                                ...
                                train_batch=train_batch_dr2d_pdebench,
                                validate_epoch=validate_epoch_dr2d_pdebench,
    ...
    val_result = validate_epoch_dr2d_pdebench(model=model,
                                              metric_func=metric_func,
                                              metric_list=metric_list,
                                              valid_loader=valid_loader,
                                              in_seq_len=in_seq_len,
...
if __name__ == '__main__':
    # main("config/dr2d_pdebench/config_gt_dr2d_pdebench.yml")
    # main("config/dr2d_pdebench/config_mamba_dr2d_pdebench.yml")
    main("config/dr2d_pdebench/config_st_dr2d_pdebench_stanx2.yml")
