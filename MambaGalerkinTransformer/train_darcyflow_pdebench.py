...
def main(config_path='config/darcyflow_pdebench/config_gt_darcyflow_pdebench.yml'):
    ...
    train_dataset = DarcyFlowDataset(dataset_params=config['dataset'], split='train')
    ...
    model_name = get_model_name(model='darcyflow_pdebench',
    ...
    result = run_train_pdebench(model=model,
                                ...
                                train_batch=train_batch_darcyflow_pdebench,
                                validate_epoch=validate_epoch_darcyflow_pdebench,
                                y_normalizer=None,
                                epochs=epochs,
                                device=device,
    ...
    val_result = validate_epoch_darcyflow_pdebench(model=model,
                                                   metric_func=metric_func,
                                                   metric_list=metric_list,
                                                   valid_loader=valid_loader,
                                                   in_seq_len=None,
...
if __name__ == '__main__':
    # main("config/darcyflow_pdebench/config_gt_darcyflow_pdebench.yml")
    # main("config/darcyflow_pdebench/config_mamba_darcyflow_pdebench.yml")
    main("config/darcyflow_pdebench/config_st_darcyflow_pdebench.yml")
