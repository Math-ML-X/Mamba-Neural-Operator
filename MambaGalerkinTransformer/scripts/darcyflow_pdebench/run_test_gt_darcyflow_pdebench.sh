...
--weight-path ./Mamba_Transformer_PDE/MambaGalerkinTransformer/runs/darcyflow_pdebench/darcyflow_pdebench_gt_Stanx2_20240616171305/darcyflow_pdebench_gt_Stanx2.pt \
--is_vis \
