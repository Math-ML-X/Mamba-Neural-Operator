...
def main(config_path='config/darcyflow_caltech/config_darcyflow_caltech.yml'):

    with open(config_path) as f:
        config = yaml.full_load(f)
    config = config['darcyflow_caltech']
    ...
    print(f"Saving model and result in {save_path}/{model_name}\n")
