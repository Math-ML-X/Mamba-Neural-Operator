...
task_name=OMamba_DarcyFlow_beta1.0
...
--eval_mode \
--is_vis \
--path_to_resume ./Mamba_Transformer_PDE/MambaOFormer/runs/darcyflow_pdebench/OMamba_DarcyFlow_beta1.0_BK/darcy_beta1.0_latest_model.ckpt \
