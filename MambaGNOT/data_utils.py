...
from models.mmgpt_mamba import MambaGNOT, MambaGNOT_ABL
from models.mmgpt_mamba_c4 import MambaGNOT_C4, MambaGNOT_C4_ABL
from models.mmgpt_st import STGNOT
from models.mmgpt_analysis import GNOT_ANALYSIS
from models.mmgpt_mamba_analysis import MambaGNOT_ANALYSIS, MambaGNOT_ANALYSIS_ABL
from models.mmgpt_st_analysis import STGNOT_ANALYSIS

def get_dataset_new(args):

    if args.dataset == "sw2d":
        from dataloader.dataset_shallow_water_2d_pdebench_d3 import ShallowWater2DDataset
        from dataloader.config_sw2d_pdebench import train_dict, test_dict

        dataset_params = {}
        dataset_params['train'] = train_dict
        dataset_params['test'] = test_dict

        dataset_params['train']['n_all_samples'] = int(args.train_num) if args.train_num != 'all' else \
        dataset_params['train']['n_all_samples']
        dataset_params['test']['n_all_samples'] = int(args.test_num) if args.test_num != 'all' else \
        dataset_params['test']['n_all_samples']
        dataset_params['train']['batch_size'] = args.batch_size
        dataset_params['test']['batch_size'] = args.val_batch_size

        dataset_params['train']['normalize_x'] = args.normalize_x
        dataset_params['train']['normalize_y'] = args.use_normalizer
        dataset_params['test']['normalize_x'] = args.normalize_x
        dataset_params['test']['normalize_y'] = args.use_normalizer

        train_dataset = ShallowWater2DDataset(dataset_params, split='train')
        test_dataset = ShallowWater2DDataset(dataset_params, split='test')

        args.dataset_config = train_dataset.config

    elif args.dataset == "sw2d_cx2":
        from dataloader.dataset_shallow_water_2d_pdebench_d3 import ShallowWater2DDataset
        from dataloader.config_sw2d_pdebench_cx2 import train_dict, test_dict
        ...
        from dataloader.dataset_diffusion_reaction_2d_pdebench_d3 import DiffusionReaction2DDataset
        from dataloader.config_dr2d_pdebench import train_dict, test_dict

        dataset_params = {}
        dataset_params['train'] = train_dict
        dataset_params['test'] = test_dict

        dataset_params['train']['n_all_samples'] = int(args.train_num)if args.train_num != 'all' else dataset_params['train']['n_all_samples']
        dataset_params['test']['n_all_samples'] = int(args.test_num) if args.test_num != 'all' else dataset_params['test']['n_all_samples']
        dataset_params['train']['batch_size'] = args.batch_size
        dataset_params['test']['batch_size'] = args.val_batch_size
        ...
        train_dataset = DiffusionReaction2DDataset(dataset_params, split='train')
        test_dataset = DiffusionReaction2DDataset(dataset_params, split='test')

        args.dataset_config = train_dataset.config

    elif args.dataset == "dr2d_cx2":
        from dataloader.dataset_diffusion_reaction_2d_pdebench_d3 import DiffusionReaction2DDataset
        from dataloader.config_dr2d_pdebench_cx2 import train_dict, test_dict
    ...
    elif args.dataset == 'darcyflow2d':
        from dataloader.dataset_darcy_flow_pdebench_d3 import DarcyFlowDataset
        from dataloader.config_darcyflow2d_pdebench import train_dict, test_dict
        ...
        train_dataset = DarcyFlowDataset(dataset_params, split='train')
        test_dataset = DarcyFlowDataset(dataset_params, split='test')

        args.dataset_config = train_dataset.config

    elif args.dataset == 'darcyflow2d_stanx1':
        from dataloader.dataset_darcy_flow_pdebench_d3 import DarcyFlowDataset
        from dataloader.config_darcyflow2d_pdebench_stanx1 import train_dict, test_dict
    ...
    elif args.dataset == 'darcyflow2d_stanx4':
        from dataloader.dataset_darcy_flow_pdebench_d3 import DarcyFlowDataset
        from dataloader.config_darcyflow2d_pdebench_stanx4 import train_dict, test_dict
    ...
    elif args.dataset == 'darcyflow2d-caltech':
        from dataloader.dataset_darcy_flow_caltech_d3 import DarcyFlowDataset
        from dataloader.config_darcyflow2d_caltech import train_dict, test_dict
...
def get_model(args):
    ...
    if args.model_name == "CGPT":
        return CGPTNO(trunk_size=trunk_size + theta_size,
        ...
        return GNOT(trunk_size=trunk_size + theta_size,
                    branch_sizes=branch_sizes,
                    output_size=output_size,
                    n_layers=args.n_layers,
                    n_hidden=args.n_hidden,
    ...
    elif args.model_name == "MambaGNOT":
        return MambaGNOT(trunk_size=trunk_size + theta_size,
                         branch_sizes=branch_sizes,
                         output_size=output_size,
                         n_layers=args.n_layers,
                         n_hidden=args.n_hidden,
                         ...
                         n_experts=args.n_experts,
                         n_inner=args.n_inner)
    elif args.model_name == "MambaGNOT_C4":
        return MambaGNOT_C4(trunk_size=trunk_size + theta_size,
                         branch_sizes=branch_sizes,
                         output_size=output_size,
                         n_layers=args.n_layers,
                         n_hidden=args.n_hidden,
                         ...
                         n_experts=args.n_experts,
                         n_inner=args.n_inner)
    elif args.model_name == "MambaGNOT_ABL":
        return MambaGNOT_ABL(trunk_size=trunk_size + theta_size,
                         branch_sizes=branch_sizes,
                         output_size=output_size,
                         n_layers=args.n_layers,
                         n_hidden=args.n_hidden,
                         ...
                         n_inner=args.n_inner,
                             ...
                             ssm_rank_ratio=args.ssm_rank_ratio
                             )

    elif args.model_name == "STGNOT":
        return STGNOT(trunk_size=trunk_size + theta_size,
                         branch_sizes=branch_sizes,
                         output_size=output_size,
                         n_layers=args.n_layers,
                         n_hidden=args.n_hidden,
    ...
    elif args.model_name == "GNOT_ANALYSIS":
        return GNOT_ANALYSIS(trunk_size=trunk_size + theta_size,
                    branch_sizes=branch_sizes,
                    output_size=output_size,
                    n_layers=args.n_layers,
                    n_hidden=args.n_hidden,
    ...
    elif args.model_name == "MambaGNOT_ANALYSIS":
        return MambaGNOT_ANALYSIS(trunk_size=trunk_size + theta_size,
                         branch_sizes=branch_sizes,
                         output_size=output_size,
                         n_layers=args.n_layers,
                         n_hidden=args.n_hidden,
    ...
    elif args.model_name == "MambaGNOT_ANALYSIS_ABL":
        return MambaGNOT_ANALYSIS_ABL(trunk_size=trunk_size + theta_size,
                         branch_sizes=branch_sizes,
                         output_size=output_size,
                         n_layers=args.n_layers,
                         n_hidden=args.n_hidden,
    ...
    elif args.model_name == "STGNOT_ANALYSIS":
        return STGNOT_ANALYSIS(trunk_size=trunk_size + theta_size,
                         branch_sizes=branch_sizes,
                         output_size=output_size,
                         n_layers=args.n_layers,
                         n_hidden=args.n_hidden,
