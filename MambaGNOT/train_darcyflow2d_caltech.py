...
def train(model,
    ...
    for epoch in range(start_epoch, end_epoch):
        ...
        val_result = validate_epoch(model,
                                    metric_func,
                                    valid_loader,
                                    device)
...
if __name__ == "__main__":
    ...
    args.dataset = 'darcyflow2d-caltech'
    ...
    test_loader = MIODataLoader(test_dataset, batch_size=args.val_batch_size, shuffle=True, drop_last=False)
    ...
    model.eval()
    val_metric = validate_epoch(model,
                                metric_func,
                                test_loader,
                                device=device)
