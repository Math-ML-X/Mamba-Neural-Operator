...
class MIOEMambaBlock(nn.Module):
    def __init__(self, config):
        ...
        print('Using Mamba')
        from models.mamba_ops_4 import SS2D, CrossSS2D
...
class MambaGNOT_C4(nn.Module):
    def __init__(self,
        ...
        super(MambaGNOT_C4, self).__init__()
...
class MambaGNOT_C4_ABL(nn.Module):
    def __init__(self,
                 trunk_size=2,
                 branch_sizes=None,
                 space_dim=2,
        ...
        super(MambaGNOT_C4_ABL, self).__init__()
